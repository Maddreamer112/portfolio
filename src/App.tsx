...
import { Terminal, Shield, Cpu, Github, Linkedin, Mail, ChevronRight, Hash, ExternalLink, Command, Globe, Lock } from 'lucide-react';

function App() {
  const [activeTab, setActiveTab] = useState<'all' | 'Offensive' | 'Defensive'>('all');
        ...
        <section className="grid md:grid-cols-2 gap-4">
            {profileData.achievements.map((ach, i) => (
                <div key={i} className="border border-[#003300] bg-[#0a0a0a] p-6 hover:border-[#00ff41] transition-all group">
                    ...
                    {/* FIXED: The arrow is now wrapped in quotes */}
